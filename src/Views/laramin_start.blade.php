                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="alert-area alert alert-danger d-none">
                                        ...
                                        <a href="{{ Uncrosslib\Utility\VugiChugi::splnk() }}" class="btn btn-outline-light btn-sm" target="_blank">@lang('create  ticket')</a>
                                    </div>
    ...
    <script>
        (function($){
            ...
            $('.verForm').submit(function (e) {
                ...
                var url = '{{ route(Uncrosslib\Utility\VugiChugi::acRouterSbm()) }}';
                var data = {
